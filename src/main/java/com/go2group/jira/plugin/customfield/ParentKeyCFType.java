...
public class ParentKeyCFType extends CalculatedCFType{

    private final CustomFieldManager customfieldManager;
    private static Logger log = LoggerFactory.getLogger(ParentKeyCFType.class);

    public ParentKeyCFType(CustomFieldManager customfieldManager) {
