 ...
 */
public class RestrictedCascadingSelect extends CascadingSelectCFType
{
    /**
     * Logger
     */
    private static final Logger log = LoggerFactory.getLogger(RestrictedCascadingSelect.class);
     ...
     */
    public RestrictedCascadingSelect(CustomFieldValuePersister customFieldValuePersister, OptionsManager optionsManager, GenericConfigManager genericConfigManager, JiraBaseUrls jiraBaseUrls, JiraAuthenticationContext authenticationContext
    		) {
    ...
    @Override
    public String getChangelogString(CustomField field, Map<String, Option> value) {
        return null;
    }
