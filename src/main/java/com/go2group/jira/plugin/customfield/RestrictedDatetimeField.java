...
public class RestrictedDatetimeField extends DateTimeCFType {

    /**
     * Logger
     */
    private static final Logger log = LoggerFactory.getLogger(RestrictedDatetimeField.class);
    ...
    public RestrictedDatetimeField(CustomFieldValuePersister customFieldValuePersister,
                                   GenericConfigManager genericConfigManager, DateTimeFormatterFactory dateTimeFormatterFactory,
        ...
        super(customFieldValuePersister, genericConfigManager, dateTimeFormatterFactory, jiraAuthenticationContext,
                applicationProperties,   dateTimeFieldChangeLogHelper);
