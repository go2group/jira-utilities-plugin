...
public class RestrictedMultiGroupField extends MultiGroupCFType{

    /**
     * Logger
     */
    private static final Logger log = LoggerFactory.getLogger(RestrictedMultiGroupField.class);
    ...
    public RestrictedMultiGroupField(CustomFieldValuePersister customFieldValuePersister,
                                     GenericConfigManager genericConfigManager, MultiGroupConverter multiGroupConverter,
                                     PermissionManager permissionManager, JiraAuthenticationContext authenticationContext,
                                     GroupManager groupManager, FieldVisibilityManager fieldVisibilityManager, JiraBaseUrls jiraBaseUrls) {
        super(customFieldValuePersister, genericConfigManager, multiGroupConverter, permissionManager, authenticationContext,
                groupManager, fieldVisibilityManager, jiraBaseUrls);
    ...
    @Override
    public Group getSingularObjectFromString(String string) throws FieldValidationException {
    ...
    @Override
    public String getChangelogString(CustomField field, Collection<Group> value) {
        return null;
    }

    @Override
    public String getChangelogValue(CustomField arg0, Collection<Group> arg1) {
        return null;
    }
