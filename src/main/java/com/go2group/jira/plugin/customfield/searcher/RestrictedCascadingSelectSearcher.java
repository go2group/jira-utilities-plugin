...
public class RestrictedCascadingSelectSearcher extends AbstractInitializationCustomFieldSearcher
    implements CustomFieldSearcher
{
    ...
    public RestrictedCascadingSelectSearcher(FieldVisibilityManager fieldVisibilityManager)
    {
