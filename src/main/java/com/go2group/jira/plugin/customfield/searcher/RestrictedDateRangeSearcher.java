...
@PublicApi
@PublicSpi
public class RestrictedDateRangeSearcher extends AbstractInitializationCustomFieldSearcher implements NaturallyOrderedCustomFieldSearcher, CustomFieldSearcher
{
    ...
    public RestrictedDateRangeSearcher
            (
    ...
    public void init(CustomField field)
    {
        ...
        this.customFieldSearcherClauseHandler = new SimpleCustomFieldSearcherClauseHandler(new RestrictedDateValidator(operandResolver, jqlLocalDateSupport),
    ...
    {
        return new RestrictedDateFieldRenderer(false, field, constants, config, velocityRenderContext,
