...
public class RestrictedGroupPickerSearcher extends AbstractInitializationCustomFieldSearcher
        implements CustomFieldSearcher, SortableCustomFieldSearcher, CustomFieldStattable
{
    ...
    public RestrictedGroupPickerSearcher(FieldVisibilityManager fieldVisibilityManager, JqlOperandResolver jqlOperandResolver,
            GroupManager groupManager, final CustomFieldInputHelper customFieldInputHelper)
    {
        this.groupConverter = ComponentAccessor.getComponent(GroupConverter.class);
        this.fieldVisibilityManager = fieldVisibilityManager;
        this.jqlOperandResolver = jqlOperandResolver;
        this.groupManager = groupManager;
        this.groupValuesGenerator = ComponentAccessor.getComponent(GroupValuesGenerator.class);
