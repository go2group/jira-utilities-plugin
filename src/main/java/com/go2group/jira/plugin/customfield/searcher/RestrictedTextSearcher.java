...
@PublicSpi
@PublicApi
public class RestrictedTextSearcher extends AbstractInitializationCustomFieldSearcher
        implements CustomFieldSearcher, NaturallyOrderedCustomFieldSearcher
{
    ...
    public RestrictedTextSearcher(final FieldVisibilityManager fieldVisibilityManager, final JqlOperandResolver jqlOperandResolver,
    ...
    public void init(CustomField field)
    {
        ...
        this.customFieldSearcherClauseHandler = new SimpleAllTextCustomFieldSearcherClauseHandler(
                new RestrictedFreeTextValidator(field.getId(), jqlOperandResolver),
