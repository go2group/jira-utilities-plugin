...
public class UserProjectRoleFieldValidator implements Validator {
    ...
    public UserProjectRoleFieldValidator(CustomFieldManager customFieldManager, GroupManager groupManager) {
    ...
    public void validate(Map transientVars, Map args, PropertySet ps)
        ...
        selected_field = (String) args.get(UserProjectRoleFieldValidatorFactory.FIELD_NAME);
    ...
    private void throwError() throws InvalidInputException {
        throw new InvalidInputException("The field: "
                + selected_field + " can't be empty for the user ("+ UserProjectRoleFieldValidatorFactory.getUserFieldDisplayName(userfield) +")  under project role " + selected_role );
    }
