...
public class UserGroupFieldValidator implements Validator {
    ...
    private static final Logger log = LoggerFactory.getLogger(UserGroupFieldValidator.class);
    ...
    public void validate(Map transientVars, Map args, PropertySet ps)
        ...
        selected_fields = (String) args.get(UserGroupFieldValidatorFactory.FIELD_NAME);
    ...
    private void checkValueEmpty(String selectedField, Object value) throws InvalidInputException{
        if (value == null || value.toString().trim().isEmpty()) {
            throwError(selectedField);
        }
    }

    private void throwError(String selected_field) throws InvalidInputException {
        throw new InvalidInputException("The field: "
                + systemFieldName.getSystemFieldName(selected_field) + " can't be empty for the user ("+ UserGroupFieldValidatorFactory.getUserFieldDisplayName(userfield) +") under group " + selected_group );
    }
